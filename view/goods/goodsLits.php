...
<div class="container">
    ...
    <div class="row" class="col-md-12">
        <table class="table">
            <tr>
                <th><a target="_blank" href="https://www.majiameng.com/redis/index.php?app=app&c=seckill&a=addQsec&gid=2&type=mysql">mysql</a></th>
                <th></th>
            </tr>
            <tr>
                <th><a target="_blank" href="https://www.majiameng.com/redis/index.php?app=app&c=seckill&a=addQsec&gid=2&type=redis">reids</a></th>
                <th></th>
            </tr>
            <tr>
                <th><a target="_blank" href="https://www.majiameng.com/redis/index.php?app=app&c=seckill&a=addQsec&gid=2&type=transaction">基于mysql事务</a></th>
                <th></th>
            </tr>
    </div>
</div>
